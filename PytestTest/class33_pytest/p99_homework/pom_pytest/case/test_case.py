...
from MyVip_V6.class01.p99_homework.pom_pytest.data_driver import yaml_driver
from MyVip_V6.class01.p99_homework.pom_pytest.page.baidu_page import BaiduPage
